...
The decision for these values was made based on the distribution of \vsini ($7.21_{-1.63}^{4.86}\kms$ with 90\% between 4.7 and $29.0\kms$) in GALAH+ DR3 and comparison with the grid values used by APOGEE DR16 \citep{Joensson2020}.
