...
%\citet{Wang2024} measured a local line width for the Li region and fit the width of the Li line separately from other lines. Instead, we use the GALAH instrumental profile convolved with the rotational velocity as the width of our lines and set the width of the Li line to be the same as the other lines in the region, better constraining the line widths. 
