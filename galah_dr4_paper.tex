...
\affiliation{To Be Decided. Including Janez Kos, Madeleine McKenzie, Ella Wang, Thomas Nordlander}
...
\author{other co-authors with significant contribution, including Ioana Ciuc{\u{a}}, Kevin Beeson, Gregor Traven, Rok Vogrin{\v{c}}i{\v{c}}}
...
\begin{itemize}
    ...
    \item Globular Clusters for low [Fe/H] accuracy Fig.~\ref{fig:galah_dr4_allstar_globular_cluster_feh_comparison}
    \begin{itemize}
