...
%\citet{Wang2024} measured a local line width for the Li region and fit the width of the Li line separately from other lines. For this work, we use the GALAH instrumental profile convolved with the rotational velocity as the width of our lines and set the width of the Li line to be the same as the other lines in the region, better constraining the line widths. 
...
We provide individual data products in an orderly fashion that allows to create links to these products based solely on the \texttt{sobject\_id}. To download data products for individual stars we recommend to create a url string and use \textsc{wget} or similar commands. For bulk downloads of the advanced data products of this section, we recommend to contact the GALAH collaboration or use the bulk download interfaces of AAO DataCentral.
...
\begin{figure*}[ht]
 \centering
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_O_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Na_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Al_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Si_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_K_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Ca_fe.png}
...
\begin{figure*}[ht]
 \centering
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Ti_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_V_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Cr_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Mn_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Co_fe.png}
 \includegraphics[width=0.88\textwidth]{figures/comparison_dr4_dr3_apo17_Ce_fe.png}
