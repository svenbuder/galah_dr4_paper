...
\begin{figure}[ht]
 ...
 \caption{\textbf{All-sky map (l,b) of equivalent width measurements of the diffuse interstellar band around $5780\,\mathrm{\AA}$, with the GSPhot extinction by \citet{Andrae2023} in the background.}}
...
While we have tried to stars with diverse abundances, such as carbon-enhanced metal-poor stars, the significant effect of their molecular features onto the whole stellar spectrum is not to be underestimated and can in-itself pose a problem to the flexibility of neural networks.
