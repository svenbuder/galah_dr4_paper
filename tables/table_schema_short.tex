...
nn\_li\_fe & Elemental abundance for [Li/Fe] & nn\_e\_li\_fe & Uncertainty nn\_li\_fe \\ 
...
mass & Mass used for calculating $\log g$ (plx) & age & Age estimated when calculating mass \\ 
bc\_ks & Bolometric Correction of $K_S$ band & a\_ks & Attenuation in $K_S$-band $A(K_S)$ \\ 
...
ks\_m & 2MASS $K_S$-band magnitude & ks\_msigcom & Uncertainty of ks\_m \\ 
